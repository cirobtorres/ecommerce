...
export function home(width:number = 24, height:number = 24, strokeWidth:number = 1.5) {
  return (
    <svg
...
export function userProfile(width:number, height:number) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export function menuBars(width:number, height:number) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export function glass(width:number, height:number, strokeWidth:number) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
